...
export default function CampaignComfortMoves() {
  return (
    <section
      className="relative w-full py-6 sm:py-10 bg-white overflow-hidden"
      aria-label="Everyday Comfort Moves With You — Walkline Footwear"
    >
      <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-8">
        ...
        >
          <Image
            ...
            alt="Everyday Comfort Moves With You — Lightweight Feel, Flexible Sole, All Day Comfort"
            fill
