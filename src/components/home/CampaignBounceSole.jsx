...
export default function CampaignBounceSole() {
  return (
    <section
      id="campaign-bounce"
      className="relative w-full py-6 sm:py-10 bg-white overflow-hidden"
      aria-label="Introducing Bounce Sole Slippers — Walkline Footwear"
    >
      <div className="w-full max-w-[1920px] mx-auto px-4 sm:px-8">
        ...
        >
          <Image
            ...
            alt="Introducing Bounce Sole Slippers — Walkline Footwear All-Day Comfort"
            fill
